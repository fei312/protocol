...
type RelaySignalRequest struct {
	...
	//
	//	*RelaySignalRequest_StartSession
	//	*RelaySignalRequest_SFUSync
	Message  isRelaySignalRequest_Message `protobuf_oneof:"message"`
...
func (m *RelaySignalRequest) GetMessage() isRelaySignalRequest_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *RelaySignalRequest) GetStartSession() *livekit.StartSession {
	if x, ok := x.GetMessage().(*RelaySignalRequest_StartSession); ok {
		return x.StartSession
	}
	return nil
}

func (x *RelaySignalRequest) GetSFUSync() *livekit.SFUSync {
	if x, ok := x.GetMessage().(*RelaySignalRequest_SFUSync); ok {
		return x.SFUSync
	}
	return nil
}
...
type isRelaySignalRequest_Message interface {
	isRelaySignalRequest_Message()
}

type RelaySignalRequest_StartSession struct {
	StartSession *livekit.StartSession `protobuf:"bytes,1,opt,name=start_session,json=startSession,proto3,oneof"`
}

type RelaySignalRequest_SFUSync struct {
	SFUSync *livekit.SFUSync `protobuf:"bytes,2,opt,name=SFUSync,proto3,oneof"`
}

func (*RelaySignalRequest_StartSession) isRelaySignalRequest_Message() {}

func (*RelaySignalRequest_SFUSync) isRelaySignalRequest_Message() {}
...
var file_rpc_signal_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xe7, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x53, 0x69, 0x67, 0x6e, 0x61,
	0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3c, 0x0a, 0x0d, 0x73, 0x74, 0x61, 0x72,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x07, 0x53, 0x46, 0x55, 0x53, 0x79, 0x6e,
	0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2e, 0x53, 0x46, 0x55, 0x53, 0x79, 0x6e, 0x63, 0x48, 0x00, 0x52, 0x07, 0x53, 0x46, 0x55,
	0x53, 0x79, 0x6e, 0x63, 0x12, 0x32, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73,
	...
	,
...
var file_rpc_signal_proto_goTypes = []interface{}{
	...
	(*livekit.SFUSync)(nil),        // 3: livekit.SFUSync
	(*livekit.SignalRequest)(nil),  // 4: livekit.SignalRequest
	(*livekit.SignalResponse)(nil), // 5: livekit.SignalResponse
}
var file_rpc_signal_proto_depIdxs = []int32{
	2, // 0: rpc.RelaySignalRequest.start_session:type_name -> livekit.StartSession
	3, // 1: rpc.RelaySignalRequest.SFUSync:type_name -> livekit.SFUSync
	4, // 2: rpc.RelaySignalRequest.requests:type_name -> livekit.SignalRequest
	5, // 3: rpc.RelaySignalResponse.responses:type_name -> livekit.SignalResponse
...
func file_rpc_signal_proto_init() {
	...
	file_rpc_signal_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RelaySignalRequest_StartSession)(nil),
		(*RelaySignalRequest_SFUSync)(nil),
	}
	type x struct{}
